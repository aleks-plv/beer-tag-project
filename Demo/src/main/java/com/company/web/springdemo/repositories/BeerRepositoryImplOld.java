...
//@Repository
public class BeerRepositoryImplOld implements BeerRepository {

    private final List<Beer> beers;

   // @Autowired
    public BeerRepositoryImplOld(StyleRepository styleRepository, UserRepository userRepository) {
        beers = new ArrayList<>();
    ...
    public List<Beer> get(String name, Double minAbv, Double maxAbv, Integer styleId, String sortBy, String sortOrder) {
        ...
        result = filterBeers(name, minAbv, maxAbv, styleId, sortBy, sortOrder, result);
        return result;
    }
